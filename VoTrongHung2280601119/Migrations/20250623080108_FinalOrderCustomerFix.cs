...
{
    /// <inheritdoc />
    public partial class FinalOrderCustomerFix : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDistributions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderDistributions_AspNetUsers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDistributionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_OrderDistributions_OrderDistributionId",
                        column: x => x.OrderDistributionId,
                        principalTable: "OrderDistributions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDistributions_CustomerId",
                table: "OrderDistributions",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_OrderDistributionId",
                table: "OrderItems",
                column: "OrderDistributionId");
